...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/张泽中/Common'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '张泽中' => '16664476+zzz1029335886@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/张泽中/Common.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '10.0'

  s.source_files = 'Common/Module/**/*.{swift}'
  s.resources = "Common/Module/**/*.{xcassets,json,storyboard,xib,xcdatamodeld}"
